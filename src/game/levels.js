export const LEVELS = [
  {
    ...
    passengerGoal: 4,
    extraPassengers: 4,
    roadCurve: { amplitude: 3.1, frequency: 1.45, phase: 0.1 },
    redLights: [0.38, 0.72],
    traffic: 16,
    cows: 2,
    cyclists: 5,
  ...
  },
  {
    ...
    passengerGoal: 5,
    extraPassengers: 4,
    roadCurve: { amplitude: 3.6, frequency: 1.65, phase: 0.45 },
    redLights: [0.32, 0.66],
    traffic: 21,
    cows: 4,
    cyclists: 8,
  ...
  },
  {
    ...
    passengerGoal: 6,
    extraPassengers: 5,
    roadCurve: { amplitude: 4.1, frequency: 1.9, phase: 0.2 },
    redLights: [0.28, 0.58, 0.82],
    traffic: 27,
    cows: 5,
    cyclists: 10,
    police: 3,
  ...
  },
  {
    ...
    passengerGoal: 7,
    extraPassengers: 5,
    roadCurve: { amplitude: 3.5, frequency: 1.55, phase: 0.65 },
    redLights: [0.3, 0.55, 0.78],
    traffic: 32,
    cows: 6,
    cyclists: 12,
    police: 4,
  ...
  },
  {
    ...
    passengerGoal: 8,
    extraPassengers: 6,
    roadCurve: { amplitude: 4.4, frequency: 2.05, phase: 0.35 },
    redLights: [0.24, 0.5, 0.74],
    traffic: 38,
    cows: 6,
    cyclists: 13,
    police: 5,
