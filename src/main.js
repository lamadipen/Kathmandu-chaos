...
const game = new KathmanduChaos({
  ...
  ui: {
    ...
    festivalToggle: document.querySelector('#festivalToggle'),
    redLightToggle: document.querySelector('#redLightToggle'),
    ...
    resultsEventBonus: document.querySelector('#resultsEventBonus'),
    resultsPowerUpBonus: document.querySelector('#resultsPowerUpBonus'),
    ...
    powerUpHud: document.querySelector('#powerUpHud'),
    trafficSignalHud: document.querySelector('#trafficSignalHud'),
    trafficSignalDistance: document.querySelector('#trafficSignalDistance'),
    trafficSignalStack: document.querySelector('#trafficSignalStack'),
